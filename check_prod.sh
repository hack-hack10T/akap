...
echo "== buy.html =="
check "buy: 14 дней на возврат"       "$SITE/guide/buy.html"   "14 дней на возврат" "7 дней на возврат|7 календарных"
...
if [[ -n "$V9_PATH" ]]; then
  ...
  check "v9: 14 дней на возврат"    "$SITE$V9_PATH" "14 дней на возврат" "7 дней на возврат|7 календарных"
